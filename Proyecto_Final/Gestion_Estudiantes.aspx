<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Principal.Master" AutoEventWireup="true" CodeBehind="Gestion_Estudiantes.aspx.cs" Inherits="Proyecto_Final.Gestion_Estudiantes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controladores/ControladorEstudiantes.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row container">
        <div class="col-sm-5">
            <h1 style="margin-top: 7px; margin-bottom: 7px;">Gestión Estudiantes</h1>
        ...
        <div class="col-sm-7" style="margin-top:7px;">
            <table id="tbl_Estudiantes" class="table table-bordered  table-striped bg-white" style="width: 100%">
