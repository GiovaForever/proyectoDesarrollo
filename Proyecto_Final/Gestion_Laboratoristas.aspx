<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Principal.Master" AutoEventWireup="true" CodeBehind="Gestion_Laboratoristas.aspx.cs" Inherits="Proyecto_Final.Gestion_Laboratoristas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controladores/ControladorLaboratoristas.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row container my-3">
        <h1 style="margin-top: 7px; margin-bottom: 7px;">Gestión Laboratoristas</h1>
    </div>
    <div class="row container">
        ...
        <div class="col-sm-7" style="margin-top: 7px;">
            <table id="tbl_Laboratoristas" class="table table-bordered  table-striped bg-white" style="width: 100%">
