...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controladores/ControladoresPrestamosInvitados.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Modal Invitados-->
    <div class="modal fade" id="ModalInvitado" tabindex="-1" role="dialog" aria-labelledby="ModalInvitadoLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalInvitadoLabel">Buscar Invitados</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <table id="tbl_Invitados" class="table table-bordered" align="center">
                        <thead class="thead-dark">
                            <tr>
                                <th>Cédula</th>
                                <th>Nombres</th>
