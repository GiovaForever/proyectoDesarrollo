<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Principal.Master" AutoEventWireup="true" CodeBehind="Reporte_PresLaboratorios.aspx.cs" Inherits="Proyecto_Final.Formulario_web16" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="row container my-3">
        <h1 class="my-3">Prestamos Laboratorios</h1>
    </div>
