...
function actualizarInvitado() {
    var data = {
        cedulaInvitado: $("#txtCedula").val(),
        nombreInvitado: $("#txtNombre").val(),
        apellidoInvitado: $("#txtApellido").val(),
        telefonoInvitado: $("#txtTelefono").val()
    };
    $.ajax({
        type: "PUT",
        ...
        success: function (data) {
            alertify.success("Invitado Modificado Correctamente");
            limpiarCampos();
            cargarTablaDatos();
        }
    });
...
function eliminarInvitado() {
    $.ajax({
        ...
        success: function (data) {
            alertify.success("Invitado Eliminado Correctamente");
            limpiarCampos();
            cargarTablaDatos();
        }
    });
...
function insertarInvitado() {
    ...
    $.ajax({
        ...
        success: function (data) {
            alertify.success("Invitado Insertado Correctamente");
            limpiarCampos();
            cargarTablaDatos();
        }
    });
