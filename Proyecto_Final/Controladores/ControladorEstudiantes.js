...
function actualizarEstudiante() {
    var data = {
        cedulaEstudiante: $("#txtCedula").val(),
        nombreEstudiante: $("#txtNombre").val(),
        apellidoEstudiante: $("#txtApellido").val(),
        telefonoEstudiante: $("#txtTelefono").val()
    };
    $.ajax({
        type: "PUT",
        ...
        success: function (data) {
            alertify.success("Estudiante Modificado Correctamente");
            limpiarCampos();
            cargarTablaDatos();
        }
    });
...
function eliminarEstudiante() {
    $.ajax({
        ...
        success: function (data) {
            alertify.success("Estudiante Eliminado Correctamente");
            limpiarCampos();
            cargarTablaDatos();
        }
    });
