<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Principal.Master" AutoEventWireup="true" CodeBehind="Prestamos_Docentes.aspx.cs" Inherits="Proyecto_Final.Prestamos_Docentes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controladores/ControladoresPrestamosDocentes.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                <table style="width: 100%">
                    ...
                    <tr style="margin-bottom: 5px">
                        <td>
                            <input type="text" id="txtCedulaDocente" name="txtCedulaDocente" class="form-control" readonly placeholder="Cédula" />
                        </td>
                        <td rowspan="2" style="text-align: center">
                            <button id="btnBuscarDocente" type="button" class=" btn btn-dark mx-3" data-toggle="modal" data-target="#ModalDocente">
                                <span class="fas fa-search mx-3"> Buscar
                            </button>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" id="txtDatosDocente" name="txtDatos" class="form-control my-2" readonly placeholder="Nombre y Apellido" />
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div class="modal fade" id="ModalDocente" tabindex="-1" role="dialog" aria-labelledby="ModalDocenteLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalDocenteLabel">Buscar Docentes</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
