<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Principal.Master" AutoEventWireup="true" CodeBehind="Reporte_PresInvitados.aspx.cs" Inherits="Proyecto_Final.Formulario_web15" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controladores/ReportePrestamoInvitados.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="row container my-3">Reporte Prestamos Invitados</h1>
    ...
    <rsweb:ReportViewer ID="ReportViewerPrestamosInvitados" runat="server" Height="448px"
        Width="709px">
    </rsweb:ReportViewer>
    <!-- Modal Prestamos-->
